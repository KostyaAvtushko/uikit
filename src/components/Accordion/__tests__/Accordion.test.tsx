...
describe('Accordion', () => {
    ...
    test('controlled multiple mode: value array controls expanded state', async () => {
        ...
        const multipleModeRerenderValue = ['item1', 'item2'];

        rerender(
            <Accordion multiple value={multipleModeRerenderValue} onUpdate={mockOnUpdate}>
                <Accordion.Item summary="Item 1" value="item1">
                    Content 1
                </Accordion.Item>
                <Accordion.Item summary="Item 2" value="item2">
        ...
        expect(mockOnUpdate).toHaveBeenCalledWith(multipleModeRerenderValue);
        expect(content1.className).toContain('g-disclosure__content_visible');
        expect(content2.className).toContain('g-disclosure__content_visible');

        const multipleModeRerenderValue2 = ['item2'];

        rerender(
            <Accordion multiple value={multipleModeRerenderValue2} onUpdate={mockOnUpdate}>
                <Accordion.Item summary="Item 1" value="item1">
                    Content 1
                </Accordion.Item>
                <Accordion.Item summary="Item 2" value="item2">
        ...
        expect(mockOnUpdate).toHaveBeenCalledWith(multipleModeRerenderValue2);
        expect(content1.className).not.toContain('g-disclosure__content_visible');
        expect(content2.className).toContain('g-disclosure__content_visible');
    });
